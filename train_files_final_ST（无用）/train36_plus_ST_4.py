...
parser.add_argument('--use_three_branch', type=bool,default=False,help='if use three branch')
parser.add_argument('--use_dynamic_graph', type=bool,default= True,help='if dynamic graph')
...
parser.add_argument('--node_num',type=int,default=100,help='node number')
