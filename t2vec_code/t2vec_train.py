...
import argparse
from t2vec_code.train import train
from t2vec_code.evaluate import evaluator, t2vec
import torch
...
parser.add_argument("-data", default=r"E:\WST_code\zhijiang_data\hangzhou_202005\raw_data",
    help="Path to training and validating data")

parser.add_argument("-checkpoint", default=r"E:\WST_code\zhijiang_data\hangzhou_202005\raw_data\t2vec_best_model.pt",
    help="The saved checkpoint")

parser.add_argument("-prefix", default="all", help="Prefix of trjfile")
...
parser.add_argument("-knearestvocabs", default=r"E:\WST_code\zhijiang_data\hangzhou_202005\raw_data\hangzhou-vocab-dist-cell100.h5",
...
parser.add_argument("-max_num_line", type=int, default=80000000)
...
# 在哈尔滨数据集中 应该设置为 19666
# 杭州五月的数据中设置为：35291
parser.add_argument("-vocab_size", type=int, default=35291,
