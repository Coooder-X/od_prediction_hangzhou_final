...
args = let s = ArgParseSettings()
    @add_arg_table! s begin
        "--datapath"
            arg_type=String
            default="E:\\WST_code\\zhijiang_data\\shanghai\\raw_data"
    end
    parse_args(s; as_symbols=true)
end

datapath = args[:datapath]
param  = JSON.parsefile("t2vec_code/hyper-parameters-shanghai.json")
...
# 2164775
createTrainVal(region, "$datapath/$cityname.h5", datapath, downsamplingDistort, 2_134_775, 30_000)
