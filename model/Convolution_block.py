...
class Convolution_block(nn.Module):
    ...
    def forward(self, X, graph_conv_filters_input):
        ...
        X = self.comput(X, graph_conv_filters_input) + self.short_path(X, graph_conv_filters_input)
    ...
    def short_path(self,X, graph_conv_filters_input):
        X = self.conv4(X, graph_conv_filters_input)
        # if self.is_batch_normalization:
